...
def load_garmin_to_db():
    ...
    db_path_absolute = str(BASE_DIR / 'arbitro.db')
    json_path_absolute = str(BASE_DIR / "training_data" / "garmin_activities.json")
    ...
    print(f"✅ Baza zaktualizowana! Przetworzono {licznik_zaktualizowanych} treningów.")
...
def scrape_garmin():
    ...
    try:
        ...
        # Na koniec aktualizujemy bazę danych (SQLite)
        load_garmin_to_db()
